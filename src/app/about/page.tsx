            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 md:gap-8 lg:gap-12">
              {skills.map((skillGroup, index) => (
                <div 
                  ...
                  className={`space-y-4 md:space-y-6 group transition-all duration-1000 ${
                ...
                >
                  ...
                  <div className="space-y-2 md:space-y-3">
                    {skillGroup.items.map((skill, skillIndex) => (
                      <div 
                        key={skill}
                        className={`flex items-center space-x-2 md:space-x-3 group-hover:translate-x-2 transition-all duration-500 ${
                          visibleSections.has(1) ? 'opacity-100' : 'opacity-0'
                        }`}
                        // style={{
