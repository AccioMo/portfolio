...
export default function NavBar({logo}: {logo: boolean}) {
    ...
    return (
        <div className="fixed flex w-full justify-between py-8 px-12 z-40 font-mono text-sm text-gray-300" data-project-area="true">
        <div>
        ...
        <div className="flex">
            ...
            <Link href="/about" className={`flex px-3 items-center group transition-all duration-300 ${pathname === '/about' ? 'opacity-100' : 'opacity-50'}`}>
                ...
                <span className={`${pathname === '/about' ? 'opacity-100' : ' opacity-70'} cursor-none group-hover:opacity-80`}>me</span>
            </Link>
            ...
            <Link href="/contact" className={`flex px-3 items-center group transition-all duration-300 ${pathname === '/contact' ? 'opacity-100' : 'opacity-50'}`}>
                ...
                <span className={`${pathname === '/contact' ? 'opacity-100' : ' opacity-70'} cursor-none group-hover:opacity-80`}>talk</span>
            </Link>
        </div>
      </div>
    )
